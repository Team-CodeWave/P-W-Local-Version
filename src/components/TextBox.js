    ...
    <>
      {
        ...
        <div className="wrapper">
          <div className="wholebox resultDiv">
            <div ref={t1Ref} className="Text-area-z1 resultDiv">{dataState.t1}</div>
          </div>
        </div>
        ...
        <div className="wrapper">
          ...
          <div className="wholebox">
            <textarea ref={t1Ref} onInput={(e)=>{t1Ref.current.style.height=""; setDataState({...dataState, t1:e.target.value})}} value={dataState.t1} placeholder='제목' className="Text-area-z1"></textarea>
          </div>
        </div>    
      }
    </>
